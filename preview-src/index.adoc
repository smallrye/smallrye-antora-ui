...
Integer diam enim, dignissim eget eros et, _ultricies mattis_ odio.
--
 ...
 */
@ApplicationScoped
public class ReactiveMessagingExample extends Object {
    private long a = 0L;
    ...
    public Multi<String> source() {
        return Multi.createFrom().items("Hello", "World", "!"); // <2>
    }
}
----
