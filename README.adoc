...
Execute `gulp pack`.
When submitting a pull request, don't forget to run the build and include the resulting `build/ui-bundle.zip` in your commit to keep it up-to-date.
...
If you don't have Gulp installed, but you do have npm, you can run `npm install` to download all dependencies and then use `npx gulp ...`.
